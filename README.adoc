= REST API Level 0 - Thorntail Booster
...
== More Information
You can learn more about this booster and rest of the Thorntail runtime in the link:http://launcher.fabric8.io/docs/thorntail-runtime.html[Thorntail Runtime Guide].
